...
$sql ="Select * from `clay_countylanddata` where '$value' in (
    Date, Type, Last_Name_Grantor_1, First_Name_Grantor_1, Last_Name_Grantor_2, First_Name_Grantor_2, Last_Name_Grantor_3, First_Name_Grantor_3, Last_Name_Grantee_1, First_Name_Grantee_1, Last_Name_Grantee_2, First_Name_Grantee_2, ADDITION, CITY)";
