...
<body>
    ...
    <div class="d-flex justify-content-center">
        <button class="btn btn-primary" href="http://localhost/app/BackendEndpoints/createData.php"> add data </button>
    </div>

    <div class="d-flex justify-content-center">
        <img src="assets/TSP6-RGE1.PNG" usemap="#image-map" class="m-5">
    </div>

    <map name="image-map">
        <area target="" alt="SEC 1" title="SEC 1" onclick="getData(6,1,1)" coords="426,235,483,292" shape="rect">
        <area target="" alt="SEC 2" title="SEC 2" onclick="getData(6,1,2)" coords="358,236,419,292" shape="rect">
        <area target="" alt="SEC 3" title="SEC 3" onclick="getData(6,1,3)" coords="292,239,350,293" shape="rect">
        <area target="" alt="SEC 4" title="SEC 4" onclick="getData(6,1,4)" coords="222,238,284,294" shape="rect">
    </map>
